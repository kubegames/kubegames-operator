...
func AdmissionFuncHandler(f admitv1Func) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		serve(w, r, newDelegateToV1AdmitHandler(f))
	})
}
...
func delegateV1beta1AdmitToV1(f admitv1Func) admitv1beta1Func {
	return func(review v1beta1.AdmissionReview) *v1beta1.AdmissionResponse {
		in := v1.AdmissionReview{Request: convert.ConvertAdmissionRequestToV1(review.Request)}
		out := f(in)
		return convert.ConvertAdmissionResponseToV1beta1(out)
	}
}
